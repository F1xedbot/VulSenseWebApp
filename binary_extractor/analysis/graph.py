...
from binary_extractor.core.edge \
...
class Graph(object):
    ...
    def view(self, view=False, simplify=False, call=False, ssa=False):#####
...
class CFGGraph(Graph):
    ...
    def __init__(self, cfg, filename='/home/hkt/Desktop/VulnSense/graph.cfg.gv', design=None):
