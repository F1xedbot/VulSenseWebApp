from binary_extractor.core.edge import Edge, EDGE_UNCONDITIONAL, EDGE_CONDITIONAL_TRUE, EDGE_CONDITIONAL_FALSE, EDGE_FALLTHROUGH, EDGE_CALL
from binary_extractor.engine.emulator import EmulatorEngine
    ...
    def ssa_stack_memory_storage_flow_instruction(self, instr, state, depth):
        ...
        if op == 'POP':
            ...
            if push_instr.ssa.is_constant:
                ...
                # reentrancy to resolve the SSA repr
